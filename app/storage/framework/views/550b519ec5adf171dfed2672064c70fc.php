<nav x-data="{ open: false }" class="w-full bg-gradient-to-r from-blue-200 to-green-200 border-b border-gray-100 rounded-lg shadow-lg">
    <!-- Primary Navigation Menu -->
    <div class="w-full max-w-screen-xl mx-auto px-0 sm:px-0 lg:px-0 py-6"> <!-- Reduced py-8 to py-6 for smaller height -->
...
<?php endif; ?>
                    ...
                    <span class="text-lg font-bold text-gray-800 mt-4">ReTech Market</span>
                </div>
            </div>

            <!-- Right Side (Links grouped closer) -->
            <div class="flex items-center space-x-4"> <!-- Reduced space-x-6 to space-x-4 for closer buttons -->
                <!-- Interested Items Link -->
                <a href="<?php echo e(route('interested-items.index')); ?>" class="text-gray-900 hover:text-black px-4 py-2 rounded-md text-lg transition duration-300 ease-in-out transform hover:scale-105">
                    Interested Items
                </a>

                <!-- Contact Us Link -->
                <a href="<?php echo e(route('contact')); ?>" class="text-gray-900 hover:text-black px-4 py-2 rounded-md text-lg transition duration-300 ease-in-out transform hover:scale-105">
                    Contact Us
                </a>

                <!-- Dashboard Link -->
                <a href="<?php echo e(route('dashboard')); ?>" class="text-gray-900 hover:text-black px-4 py-2 rounded-md text-lg transition duration-300 ease-in-out transform hover:scale-105">
                    Dashboard
                </a>
...
<?php endif; ?>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden py-4">
...
<?php /**PATH D:\Software Engineering\retech-market\app\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>